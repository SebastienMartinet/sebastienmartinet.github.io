...
df=pd.read_csv('/home/seb/Recherche/Talys/Plots/Table_total_with_contrib.csv')
...
def plot_data(selected_xaxis,selected_yaxis):

    # Build the matplotlib figure
    fig = plt.figure(figsize=(14, 5))
    plt.scatter(df[selected_xaxis], df[selected_yaxis])
    plt.ylabel(selected_yaxis)
    plt.xlabel(selected_xaxis)
    ...
    fig_bar_plotly = px.scatter(df, x=selected_xaxis, y=selected_yaxis).update_xaxes(tickangle=330)
